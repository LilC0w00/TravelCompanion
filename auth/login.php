  ...
  if (empty($errors)) {
    try {
      ...
      if ($user && password_verify($password, $user['password'])) {
        ...
        // Rediriger vers l'index (page d'accueil)
        header("Location: ../index.html");
        exit();
      } else {
  ...
  <main>
    <div class="form-container">
      ...
      <form method="POST" action="login.php">
        ...
        <div class="form-row">
          <div class="form-group" style="width: 100%;">
            <a href="../auth/auth.php" class="connect-btn" style="display: block; text-align: center; text-decoration: none;">Créer un compte</a>
          </div>
        </div>
      </form>
    </div>
